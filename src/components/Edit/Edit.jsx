...
<input type="text" id="numeroAfiliado"  onChange={(ev) => setAbuelo({ ...abuelo, numeroAfiliado: ev.target.value })}
            {...register('numeroAfiliado', { required: false })}
/>

<label htmlFor="estadoCivil">Estado civil:</label>
<input type="text" id="estadoCivil" onChange={(ev) => setAbuelo({ ...abuelo, estadoCivil: ev.target.value })}
            {...register('estadoCivil', { required: false })}
/>

<label htmlFor="servicioEmergencia">Servicio de emergencia:</label>
<input type="text" id="servicioEmergencia"  onChange={(ev) => setAbuelo({ ...abuelo, servicioEmergencia: ev.target.value })}
            {...register('servicioEmergencia', { required: false })}
/>

<label htmlFor="telefonoEmergencia">Telefono de emergencia:</label>
<input type="number" id="telefonoEmergencia"  onChange={(ev) => setAbuelo({ ...abuelo, telefonoEmergencia: ev.target.value })}
            {...register('telefonoEmergencia', { required: false })}
/>

<label htmlFor="autorizadoSalir">¿Autorizado a salir?:</label>
<input type="text" id="autorizadoSalir"  onChange={(ev) => setAbuelo({ ...abuelo, autorizadoSalir: ev.target.value })}
            {...register('autorizadoSalir', { required: false })}
/>

<label htmlFor="nombreParientes">Nombre y apellido del familiar responsable:</label>
<input type="text" id="nombreParientes"  onChange={(ev) => setAbuelo({ ...abuelo, nombreParientes: ev.target.value })}
  {...register('nombreParientes', { required: false })}
/>

<label htmlFor="documentoPariente">Documento del familiar:</label>
<input type="number" id="documentoPariente"  onChange={(ev) => setAbuelo({ ...abuelo, documentoPariente: ev.target.value })}
  {...register('documentoPariente', { required: false })}
/>

<label htmlFor="parentezco">Parentezco:</label>
<input type="text" id="parentezco" onChange={(ev) => setAbuelo({ ...abuelo, parentezco: ev.target.value })}
  {...register('parentezco', { required: false })}
/>

<label htmlFor="domicilioPariente">Domicilio:</label>
<input type="text" id="domicilioPariente"  onChange={(ev) => setAbuelo({ ...abuelo, domicilioPariente: ev.target.value })}
  {...register('domicilioPariente', { required: false })}
/>

<label htmlFor="telefono1">Telefono 1:</label>
<input type="number" id="telefono1"  onChange={(ev) => setAbuelo({ ...abuelo, telefono1: ev.target.value })}
  {...register('telefono1', { required: false })}
/>

<label htmlFor="telefono2">Telefono 2:</label>
<input type="number" id="telefono2"  onChange={(ev) => setAbuelo({ ...abuelo, telefono2: ev.target.value })}
  {...register('telefono2', { required: false })}
/>

<label htmlFor="telefono3">Telefono 3:</label>
<input type="number" id="ntelefono3"  onChange={(ev) => setAbuelo({ ...abuelo, telefono3: ev.target.value })}
  {...register('telefono3', { required: false })}
/>

<label htmlFor="email">Email:</label>
<input type="email" id="email"  onChange={(ev) => setAbuelo({ ...abuelo, email: ev.target.value })}
  {...register('email', { required: false })}
/>

<label htmlFor="documentoFrente">Foto del frente del documento:</label>
<input type="file" id="documentoFrente" onChange={(ev) => setAbuelo({ ...abuelo, documentoFrente: ev.target.value })}
  {...register('documentoFrente', { required: false })}
/>

<label htmlFor="documentoDorso">Foto del dorso del documento:</label>
<input type="file" id="documentoDorso" name="documentoDorso" onChange={(ev) => setAbuelo({ ...abuelo, documentoDorso: ev.target.value })}
  {...register('documentoDorso', { required: false })}
/>

<label htmlFor="prepagaFrente">Foto del frente del carnet obra social:</label>
<input type="file" id="prepagaFrente" name="prepagaFrente" onChange={(ev) => setAbuelo({ ...abuelo, prepagaFrente: ev.target.value })}
  {...register('prepagaFrente', { required: false })}
/>

<label htmlFor="prepagaDorso">Foto del dorso del carnet obra social:</label>
<input type="file" id="prepagaDorso" name="prepagaDorso" onChange={(ev) => setAbuelo({ ...abuelo,prepagaDorso: ev.target.value })}
  {...register('prepagaDorso', { required: false })}
/>

<label htmlFor="comentario">Comentario:</label>
<textarea id="comentario" name="comentario"  onChange={(ev) => setAbuelo({ ...abuelo, comentario: ev.target.value })}
  {...register('comentario', { required: false })}
></textarea>

<label htmlFor="estado">Estado:</label>
<input type="text" id="estado" name="estado" placeholder='activo o inactivo'  onChange={(ev) => setAbuelo({ ...abuelo, estado: ev.target.value })}
